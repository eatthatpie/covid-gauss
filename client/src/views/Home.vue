    ...
    <ul class="text-center pv-10">
      ...
      <li>
        <a
          ...
          target="_blank"
          rel="noreferrer"
          class="color-primary fs-16"
        >
          Wikipedia article about normal distribution
        </a>
      </li>
    </ul>
  </div>
